...
namespace ISC_ELIB_SERVER.Services.Interfaces
{
    public interface ITestService
    {
        ...
        ApiResponse<ICollection<TestByStudentResponse>> GetTestesByStudent(int? page, int? pageSize, string? search, string? sortColumn, string? sortOrder, int status, long? subjectId, long? gradeLevelsId, string? date, string? userId);
